...
fun MainScreen() {
    ...
    val productList = listOf(
        Product(1, "Product 1", R.drawable.product_image_1, "Description of Product 1"),
        Product(2, "Product 2", R.drawable.product_image_2, "Description of Product 2"),
        Product(3, "Product 3", R.drawable.product_image_3, "Description of Product 3")
    )
    ...
    Column(
        ...
        BasicTextField(
            ...
            modifier = Modifier
                ...
                .clickable { /* Handle focus if needed */ }
        )
...
fun ProductItem(product: Product) {
    ...
    Card(
        modifier = Modifier
            .fillMaxWidth()
            .padding(8.dp)
            .clickable { /* Handle product click if needed */ },
